...
<div class="titulo">
  <br>
  <h3 align="center">Cuestionario - Movimiento de Proyectiles</h3>
</div>
<br>
...
<div id="section">
  <div id="child">
<form action="cuestionario_proyectiles_finalizado" method="get">
    ...
    <div @if($key==0) class="tab-pane fade show active" @else class="tab-pane fade" @endif  id="{{$key+1}}" role="tabpanel">
      ...
      @if($question->image!=null)
        <div class="row justify-content-md-center">
         <img src="{{ asset('images/cuestionario/proyectil/'.$question->image ) }}" height="120">
        </div>
      @endif
      ...
      @if($question->type == "SeleccionarImage")
        ...
        @foreach($respuestas as $k => $respuesta)
            <div class="col-md-3">
              <div class="radio">
            <input type="radio" id="{{$key+1}}" name="{{$key+1}}" value="{{$respuesta}}"><label><b> {{$abc[$k]}}) </b> <img src="{{ asset('images/cuestionario/proyectil/'.$respuesta ) }}" width="120"> </label>
            </div>
        </div>
        @endforeach
        </div>
