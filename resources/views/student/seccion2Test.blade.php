...
<body>
	...
	<div class="container">
		<div class="titulo">
			<h4 align="left" class="animated">Sección 2</h4>
		</div>
		...
		<div class="contenido">
			...
			<div class="row">
				<div class="col-md-2 col-sm-12 ">
					...
					<br>
					<form action="test_estilo_congnitivo_s3" id="formC2" method="get">
						<input type="hidden" name="aciertoC1" value="{{ $aciertoS1 }}">
						<input type="hidden" name="aciertoC2" id="C2" value="0">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							...
							<center>
							<button onclick="siguienteSeccion()"class="btn btn-primary boton" type="submit" id="seccion3">Siguiente sección</button>
						</center>
						</form>
							...
							<div class="tab-pane" id="tabs-9" role="tabpanel">
								<div class="row justify-content-md-center">
									<div class="col-md-4 offset-md-3 c1f1">
										...
										<br><b>Encuentra la figura simple "H".</b>
										</center>
									</div>
									<div class="col-md-4">
										<div class="row">
		...
		<script type="text/javascript" src="{{ asset('js/test/seccion2F1.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F2.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F3.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F4.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F5.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F6.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F7.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F8.js') }}"></script>
		<script type="text/javascript" src="{{ asset('js/test/seccion2F9.js') }}"></script>
...
function siguienteSeccion(){
	var a=validarF1()+validarF2()+validarF3()+validarF4()+validarF5()+validarF7()+validarF8()+validarF9();
	document.getElementById("C2").value = a.toString();	
}
	...
	img1.src="{{ asset('images/test/seccion2/s2f1.png')}}";
...
var stage2 = document.getElementById('canvas2');
	...
	img2.src="{{ asset('images/test/seccion2/s2f2.png')}}";
...
$('#ultimoF2').on('click', function(){
	...
	img3.src="{{ asset('images/test/seccion2/s2f3.png')}}";
...
var stage4 = document.getElementById('canvas4');
	...
	img4.src="{{ asset('images/test/seccion2/s2f4.png')}}";
...
var stage5 = document.getElementById('canvas5');
	...
	img5.src="{{ asset('images/test/seccion2/s2f5.png')}}";
...
var stage6 = document.getElementById('canvas6');
	...
	img6.src="{{ asset('images/test/seccion2/s2f6.png')}}";
...
var stage7 = document.getElementById('canvas7');
	...
	img7.src="{{ asset('images/test/seccion2/s2f7.png')}}";
...
var stage8 = document.getElementById('canvas8');
	...
	img8.src="{{ asset('images/test/seccion2/s2f8.png')}}";
...
var stage9 = document.getElementById('canvas9');
	...
	img9.src="{{ asset('images/test/seccion2/s2f9.png')}}";
...
window.onload = function() {
	...
	ctx9.drawImage(img9, 10, 10);
		...
		intervalo = setInterval(function(){
			...
			siguienteSeccion();
				document.getElementById("formC2").submit();
			}
		}, 1000);
