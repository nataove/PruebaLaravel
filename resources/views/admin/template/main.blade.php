        ...
        <div class="left_nav">
          ...
          <div id="sidebar_left">
            <div class="menu">
              <ul class="nav m">
                <div class="clearfix"></div>
                <li id="menu_1"><a href="{{url('admin/user')}}"><i class="fa fa-home"></i> Inicio</a></li>
                <li id="menu_2"><a href="@yield('perfilEditar')"><i class="fa fa-edit"></i> Editar Perfíl</a></li>
                <li id="menu_3"><a><i class="fa fa-users"></i> Docente <span class="fa fa-caret-down"></span></a>
                ...
                <li id="menu_4"><a><i class="fa fa-graduation-cap"></i>Estudiante <span class="fa fa-caret-down"></span></a>
                  <ul class="nav child_menu">
                      <li><a href="@yield('registrarEstudiante')">Registrar</a></li>
                      <li><a href="#">Consultar</a></li>
                    </ul>
                </li>
                <li id="menu_5"><a><i class="fa fa-question"></i> Cuestionario <span class="fa fa-caret-down"></span></a>
                  <ul class="nav child_menu">
                      <li><a href="@yield('registrarCuestionario')">Registrar</a></li>
                      <li><a href="#">Consultar</a></li>
                    </ul>
                </li>
                </ul>
