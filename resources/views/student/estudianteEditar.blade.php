...
@section('content')
      ...
      <div class="title">
        <h2><small>Editar Perfíl</small></h2>
         ...
         <div class="body_form">
          ...
          {!! Form::model($user, array('route' => ['cargarEstudiante', $user->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}<div class="row">
            <div class="col-md-4">
    ...
    <div class="form-group">
      ...
      <a href="{{ $url }}"  style="background: #2C3E50" style="border-color:#18BC9C" class="btn btn-primary btn-default" >Regresar</a>
      </center>
      </div>
