...
var puntoX3 = [10,37,65,87,88,66,7,37,37,9,88];
var puntoY3 = [40,10,42,41,92,92,91,67,10,10,10,11];

var selectCorrect3 = [0,0,0,0,0,0,0];
var totalSelect3 = 0;
...
function validarF3(){
	...
	for(var i=0; i<puntosXSelect3First.length-1; i++){
		if(puntosXSelect3[0]>=puntoX3[0]-5&&puntosXSelect3[0]<=puntoX3[0]+5&&puntosYSelect3[0]>=puntoY3[0]-5&&puntosYSelect3[0]<=puntoY3[0]+5){
			...
			if(puntosXSelect3[1]>=puntoX3[0]-5&&puntosXSelect3[1]<=puntoX3[0]+5&&puntosYSelect3[1]>=puntoY3[0]-5&&puntosYSelect3[1]<=puntoY3[0]+5){
				val3 = val3;
				pSelect3[6]=1;
			}
			else if(puntosXSelect3[1]>=puntoX3[5]-5&&puntosXSelect3[1]<=puntoX3[5]+5&&puntosYSelect3[1]>=puntoY3[5]-5&&puntosYSelect3[1]<=puntoY3[5]+5){
	...
	if(val3==0 && totalPSelect3==8 && totalSelect3==6){
		validar3 = 1;
	}
