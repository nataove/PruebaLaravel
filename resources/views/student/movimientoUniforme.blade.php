...
<div class="bread">
  <div id="bc1" class="btn-group btn-breadcrumb breadcrumb-primary">
    ...
    <a href="#" class="btn btn-primary visible-lg-block visible-md-block sel"><div>Movimiento Rectilíneo Uniforme</div></a>
  </div>
</div>
<br>
...
<div class="container">
  <div class="row menu justify-content-md-center">
    <div class="men col-md-3" align="center">
      <br>
      <a href="{{ route('temaUniformeObjetivo') }}"><img class="animatedRotate" src="{{ asset('images/contenido.png') }}" width="80" height="80"></a>
      <h4>Objetivos</h4>
      <br>
    </div>
    <div class="men men2 col-md-3" align="center">
      <br>
      <a href="{{ route('temaUniformeContenido') }}"><img class="animatedRotate" src="{{ asset('images/objetivo.png') }}" width="80" height="80"></a>
      <h4>Contenido</h4>
      <br>
    </div>
    <div class="men men2 col-md-3" align="center">
      <br>
      <a href="{{ route('temaUniformeCuestionario') }}"><img class="animatedRotate" src="{{ asset('images/cuestionario.png') }}" width="80" height="80"></a>
      <h4>Cuestionario</h4>
      <br>
    </div>
  </div>
