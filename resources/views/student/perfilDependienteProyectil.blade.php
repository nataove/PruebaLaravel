            ...
            <div class="modal-body proyModal">
              <div class="row">
                ...
                <div class="modal fade" id="modalPracticaVel" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                   ...
                                   <div class="mov">
                                    ...
                                    <div class="row menu justify-content-md-center">
                                      <div class="men col-md-3 col-sm-10 col-xs-10" align="center">
                                        <br>
                                        <a onclick="volver()" id="volver"><img src="{{ asset('images/temas/proyectil.png') }}" width="80" height="80"></a>
                                        <h4><br>Volver</h4>
                                        <br>
                                      </div>
                                      <div class="men men2 col-md-3 col-sm-10 col-xs-10" align="center">
                                        <br>
                                        <a href="{{ route('circularDependiente') }}"><img src="{{ asset('images/temas/circulo.png') }}" width="80" height="80"></a>
                                        <h4><br>Movimiento Circular Uniforme</h4>
                                        <br>
                                      </div>
                  ...
                  if (n < 1) {
                  window.location.replace("caidaDependiente");   
                }
                else{
                var i = 8;
