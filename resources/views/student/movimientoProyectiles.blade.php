...
<div class="container">
  <div class="row menu justify-content-md-center">
    <div class="men col-md-3" align="center">
      <br>
      <a href="{{ route('temaProyectilesObjetivo') }}"><img class="animatedRotate" src="{{ asset('images/contenido.png') }}" width="80" height="80"></a>
      <h4>Objetivos</h4>
      <br>
    </div>
    <div class="men men2 col-md-3" align="center">
      <br>
      <a href="{{ route('temaProyectilesContenido') }}"><img class="animatedRotate" src="{{ asset('images/objetivo.png') }}" width="80" height="80"></a>
      <h4>Contenido</h4>
      <br>
    </div>
    <div class="men men2 col-md-3" align="center">
      <br>
      <a href="{{ route('temaProyectilesCuestionario') }}"><img class="animatedRotate" src="{{ asset('images/cuestionario.png') }}" width="80" height="80"></a>
      <h4>Cuestionario</h4>
      <br>
    </div>
  </div>
