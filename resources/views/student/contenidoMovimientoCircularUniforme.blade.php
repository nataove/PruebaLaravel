...
<div class="col-md-12 col-sm-6">
  <ul class="nav nav-tabs responsive-tabs">
    ...
    <li class="titulo"><a href="#movimientoCircular"><h3><b>Movimiento Circular</b></h3></a></li>
    <li class="titulo"><a href="#movimientoCircularUniforme"><h3><b>Movimiento Circular Uniforme</b></h3></a></li>
    ...
    <div class="tab-pane active" id="introduccion">
      <div class="mov">
        ...
        <div class="tab-pane" id="movimientoCircular">
      <div class="mov">
...
<div class="atom">
    ...
    <div class="neutron n2"></div>
         ...
         <div class="tab-pane" id="movimientoCircularUniforme">
      <div class="mov">
